...
import "../global.css"
export const arrRoutes: string[] = ['get_started_screen', 'invitation_screen', 'phone_number_screen', 'otp_input_screen', 'full_name_screen', 'email_screen', 'choose_investor_screen']
